...
`<p class="textRightClass">במידה והינך מעוניין בטיפול רפואי עלייך לפנות למפקד. המפקד ייפנה אותך למסדר חופ"ל. מסדר חופ"ל מתקיים אחת ליום כל יום, בהתאם לפוקדות הצבא. <br> במסדר חופ"ל תקבל את הטיפול . הייעוץ הרפואי אשר בסמכות החובש, במידה ויש צורך החופ""ל יפנה אותך לרופא היחידה. אצל רופא היחידה תקבל את המשך הטיפול הרפואי - כולל יפול תרופתי, הפניות לבירור נוסף, פטורים וימי מנוחה. </p>`];
